package io.chunkworld.api.core.assets.urn;
 ...
 * <li>an instance urn indicates a resource that is an independent copy of a resource identified by the rest of the urn</li>
 * </ul>
...
public final class ResourceUrn implements Comparable<ResourceUrn> {
    ...
    public ResourceUrn(String urn) {
        ...
        if (match.matches()) {
            ...
            throw new IOException("Invalid Urn: '" + urn + "'");
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceUrn) {
            ...
            var equals = Objects.equal(moduleName, other.moduleName) && Objects.equal(resourceName, other.resourceName)
                    && Objects.equal(fragmentName, other.fragmentName) && instance == other.instance;
            return equals || this.toString().equals(other.toString());
